...
|	|	|
| [An Introduction to the Theory of Numbers](https://www.amazon.com/Introduction-Theory-Numbers-Ivan-Niven/dp/0471625469), [Lectures](https://www.youtube.com/watch?v=EzE6it9kAsI&list=PL8yHsr3EFj53L8sMbzIhhXSAOpuZ1Fov8), [Exercises](https://ocw.mit.edu/courses/18-781-theory-of-numbers-spring-2012)	|	Number theory (Using Richard B lectures)      | Done   |	left the last few lectures i.e. prime number theorem proofs, things that play with Dirichlet characters untouched, until a more systemetic study of analytic number theory	|
...
|	|	|
| [MIT 6.041 Probabilistic Systems Analysis and Applied Probability](https://ocw.mit.edu/courses/6-041sc-probabilistic-systems-analysis-and-applied-probability-fall-2013/)	|	Probability theory	|	Done	|	except just skimmed through the last few lectures about statistical inferences	|
